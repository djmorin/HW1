...
console.log("Currently it is " + weatherData.current.temperature + " degrees and "
+ weatherData.current.conditions);
console.log("The next day we will see " + weatherData.forecast[0].conditions + " skies, with a temperature of "
